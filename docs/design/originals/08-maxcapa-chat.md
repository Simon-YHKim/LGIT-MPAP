...
> Variant tag: **(추가)** · Original file: `MaxCapa Chat.html`
...
- MaxCapa Chat(대화형 생산지표조회)
- 기본 조회는 MES UPH(uph_input_runtime_daily_model), 질문에 ITAS를 명시하면 ITAS UPH(itas_uph_result)로 조회합니다.
- 지원 예시:
- 질문 입력
- 질문 분석 및 실행
